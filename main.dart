    ...
    if (appState.pageIndex == 0) {
      return ListView(
        children: <Widget>[
          ...
          //This widget is for user login information.
          //If user is logged in, will indicate that on the page. If not, user will be prompted to log in.
          //Further details will be shown in separate widget.
          Authentication(
